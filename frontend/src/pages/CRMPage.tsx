        ...
        <div className="max-w-4xl mx-auto text-center py-16">
          ...
          <motion.div variants={staggerContainer} initial="initial" animate="animate" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
            {features.map(({ icon: Icon, title, desc }) => (
              <motion.div variants={staggerItem} key={title} className="bg-neutral-900 border border-neutral-700 rounded-xl p-6 text-left hover:border-purple-500/30 transition-colors">
